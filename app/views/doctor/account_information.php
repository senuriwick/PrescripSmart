        ...
        <div class="main">
            ...
            <div class="patientInfoContainer">
                ...
                <div class="inquiriesDiv">
                    <h1>Employee ID: #<?php echo $doctor->user_ID ?>
                    </h1>
                    <p class="sub1" style="font-weight: bold;">Account Information</p>

                    <div class="accInfo">
                        <form action="<?php echo URLROOT; ?>/doctor/accountInfoUpdate" method="POST">
                            <div class="parallel">
                                <div class="input-group">
                                    <label for="name">Username</label>
                                    <input type="text" id="username" class="input" name="username"
                                        value="<?php echo $doctor->username ?>" style="display: inline-block;">
                                </div>
                                <div class="input-group">
                                    <label for="email">Associated Email Address/Phone Number</label>
                                    <?php if ($doctor->method_of_signin == "Email"): ?>
                                        <input type="text" id="email" class="input" name="email" readonly
                                            value="<?php echo $doctor->email_phone ?>" style="display: inline-block;">
                                    <?php else: ?>
                    ...
                    <div class="accInfo">
                        <form action="<?php echo URLROOT; ?>/doctor/passwordReset" method="POST">
                            <div class="input-group">
        ...
        $(document).ready(function () {
            function checkPasswords() {
                ...
                if (newPassword !== '' && confirmPassword !== '') {
                    ...
                    $.ajax({
                        url: '/prescripsmart/doctor/checkPassword',
                        method: 'POST',
