...
<body>
    <div class="sideMenu">
        ...
        <div class="manageDiv">
            <p class="mainOptions">Doctor Tools</p>

            <div class="menu-item patients">
                <img src="<?php echo URLROOT; ?>/public/img/doctor/patient_icon.png" alt="icon">
                <a href="<?php echo URLROOT; ?>/doctor/patients" id="patients">Patients</a>
            </div>
            <div class="menu-item on-going">
                <img src="<?php echo URLROOT ?>/public/img/doctor/ongoing_icon2.png" alt="icon">
