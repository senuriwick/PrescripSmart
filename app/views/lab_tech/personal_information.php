...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT ?>\public\css\lab_tech\profile_dashboard_2.css" />
</head>
...
<body>
        ...
        <div class="main">
            ...
            <div class="patientInfoContainer">
                ...
                <div class="inquiriesDiv">
                    <form action="<?php echo URLROOT; ?>/LabTechnician/personalInfoUpdate" method="POST">
                        <h1>Employee ID: #
                            ...
                            <div class="parallel">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="regno" name="regno" class="input"
                                        style="display: inline-block;" value="<?php echo $tech->registration_No; ?>">
                                </div>
                                <div class="input-group">
                                    <label for="Qualification">Qualifications</label>
                                    <input type="text" id="qual" name="qual" class="input"
                                        style="display: inline-block;" value="<?php echo $tech->qualifications; ?>">
                                </div>
                            </div>
                            <div class="parallel">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="dep" name="dep" class="input"
                                        style="display: inline-block;" value="<?php echo $tech->department; ?>">
                                </div>
                                <div class="input-group">
                                    <label for="specialization">Specialization (If Any)</label>
                                    <input type="text" id="spec" name="spec" class="input"
                                        style="display: inline-block;" value="<?php echo $tech->specialization; ?>">
                                </div>
                            </div>
                        </div>
    ...
    function updateProfilePicture(imageData) {
        ...
        xhr.open('POST', '<?php echo URLROOT; ?>/LabTechnician/updateProfilePicture', true);
        xhr.onload = function () {
            if (xhr.status === 200) {
