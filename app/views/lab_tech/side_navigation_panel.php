...
<body>
    <div class="sideMenu">
        ...
        <div class="manageDiv">
            <p class="mainOptions">Lab Technician Tools</p>

            <div class="menu-item patients">
                <img src="<?php echo URLROOT; ?>/public/img/lab_tech/patient_icon.png" alt="icon">
                <a href="<?php echo URLROOT; ?>/LabTechnician/patient" id="patients">Patients</a>
            </div>
            <div class="menu-item profile">
                <img src="<?php echo URLROOT ?>/public/img/lab_tech/account_icon.png" alt="icon">
                <a href="<?php echo URLROOT; ?>/LabTechnician/personal_information" id="profile">Profile</a>
            </div>
        </div>
