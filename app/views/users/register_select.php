            ...
            <div class="sign-up-form">
                ...
                <script>
                    document.getElementById("continue").addEventListener("click", function () {
                        window.location.href = "<?php echo URLROOT ?>/users/register_email";
                    });
                </script>
                ...
                <script>
                    document.getElementById("phoneSignUpButton").addEventListener("click", function () {
                        window.location.href = "<?php echo URLROOT ?>/users/register_phone";
                    });
                </script>
                ...
                <p class="already-have-an-account-sign-in-here">
                    ...
                    <a href='<?php echo URLROOT ?>/users/login'; class="already-have-an-account-sign-in-here-2">here</a>
                </p>
            </div>
