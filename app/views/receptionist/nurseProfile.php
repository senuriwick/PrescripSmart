...
<body>
                                        ...
                                        <div class="bar2">
                                                <div class="div-specifier">
                                                        <div class="user-details">
                                                                ...
                                                                <h1><strong><?php echo ucwords($data['doctor']->first_name) ?>
                                                                                <?php echo ucwords($data['doctor']->last_name) ?></strong>
                                                                </h1>
                                                        </div>
                                                ...
                                                <div class="row1">
                                                        <div class="firstname">
                                                                <h2>First Name</h2>
                                                                <input type="text"
                                                                        value="<?php echo ucwords($data['doctor']->first_name) ?>">
                                                        </div>
                                                        <div class="lastname">
                                                                <h2>Last Name</h2>
                                                                <input type="text"
                                                                        value="<?php echo ucwords($data['doctor']->last_name) ?>">
                                                        </div>
                                                </div>
                                                ...
                                                <div class="row2">
                                                        <div class="firstname">
                                                                <h2>Display Name</h2>
                                                                <input type="text"
                                                                        value="<?php echo ucwords($data['doctor']->display_name) ?>">
                                                        </div>
                                                ...
                                                <div class="row1">
                                                        ...
                                                        <div class="lastname">
                                                                ...
                                                                <input type="text"
                                                                        value="<?php echo $data['doctor']->phone_number ?>">
                                                        </div>
                                                </div>
                                                ...
                                                <div class="row1">
                                                        ...
                                                        <div class="lastname">
                                                                ...
                                                                <input type="text"
                                                                        value="<?php echo $data['doctor']->Qualification ?>">
                                                        </div>
                                                </div>
                                                ...
                                                <div class="row1">
                                                        ...
                                                        <div class="lastname">
                                                                ...
                                                                <input type="text"
                                                                        value="<?php echo ucwords($data['doctor']->Specialization) ?>">
                                                        </div>
                                                </div>

                                                <div class="btn">
                                                        <button type="submit" onclick="openPopup()"><b>Save
                                                                        Changes</b></button>
                                                </div>
        ...
        <div class="bar2">
            ...
            <div class="row1">                   
                ...
                <div class="lastname">
                        <h2>Qualifications</h2>
                        <input type="text" value="<?php echo $data['doctor']->Qualification ?>">
                </div> 
            </div>
