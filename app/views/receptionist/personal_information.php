...
<body>
        ...
        <div class="main">
            ...
            <div class="patientInfoContainer">
                ...
                <div class="inquiriesDiv">
                    <form action="<?php echo URLROOT; ?>/receptionist/personalInfoUpdate" method="POST">
                        <h1>Employee ID: #
                            ...
                            <div class="parallel">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="qual" name="qual" class="input"
                                        style="display: inline-block;" value="<?php echo $receptionist->qualifications; ?>">
                                </div>
                            </div>
                            <div class="parallel">
                                <div class="input-group">
    ...
    function updateProfilePicture(imageData) {
        ...
        xhr.open('POST', '<?php echo URLROOT; ?>/receptionist/updateProfilePicture', true);
        xhr.onload = function () {
            if (xhr.status === 200) {
