    ...
    <div class="sideMenu">
        ...
        <div class="othersDiv">
            <div class="sub-menu-item">
                <img src="<?php echo URLROOT ?>/public/img/patient/billing_icon.png" alt="icon">
                <a href="<?php echo URLROOT; ?>/general/billing.html" id="billing">Billing</a>
            </div>
            <div class="sub-menu-item">
                <img src="<?php echo URLROOT ?>/public/img/patient/terms_icon.png" alt="icon">
                <a href="<?php echo URLROOT; ?>/general/terms_of_service.html" id="terms">Terms of Service</a>
            </div>
            <div class="sub-menu-item">
                <img src="<?php echo URLROOT ?>/public/img/patient/privacy_icon.png" alt="icon">
