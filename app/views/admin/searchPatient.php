...
<head>
  ...
  <!-- <link rel="stylesheet" href="<?php echo URLROOT ?>/css/admin/nav_patient.css"/> -->
        ...
        <div class="searchFiles">
          <div class="addapp">
            <div class="newapp">
              ...
              <a href="<?php echo URLROOT ?>/admin/viewRegpatient">NEW PATIENT</a>
            </div>
          </div>

          <div class="searchDiv">
            <h1>Search Patient</h1>
            <input type="text" id="searchinput" class="searchinput" placeholder="Enter patient's name here">
            <!-- <button type="search" id="searchButton" class="searchButton"><b>SEARCH</b></button> -->
...
=======
                        <td>
                          ...
                          <form id="deleteForm_<?php echo $post->patient_ID ?>" method="post"
                            action="<?php echo URLROOT; ?>/admin/deleteProfilePatient/<?php echo $post->patient_ID ?>">
