    ...
    <?php include 'side_navigation_panel.php'; ?>
        ...
        <?php include 'in_page_navigation.php'; ?>
            ...
            <img src="<?php echo URLROOT; ?>\public\img\patient\back_arrow_icon.png" alt="back-icon" class="back-icon"
              id="back-icon">
            <img src="<?php echo URLROOT; ?>\public\uploads\profile_images\<?php echo $receptionist->profile_photo ?>"
              alt="patient-pic" class="patient-pic">

            <div class="fileInfo">
            <?php if ($receptionist->gender == "male"): ?>
                <p class = "name">Mr.
                  <?php echo $receptionist->display_Name; ?>
                </p>
              <?php else: ?>
                <p class = "name">Ms.
                  <?php echo $receptionist->display_Name; ?>
              ...
              <p class="patientIdClass">Employee ID #<?php echo $receptionist->receptionist_ID; ?>
              </p>
            </div>
          </div>
                        ...
                        <div class="accInfo">
                            <div class="parallel">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="fname" name="fname" class="input"
                                        style="display: inline-block;" value="<?php echo $receptionist->first_Name; ?>" readonly>
                                </div>
                                <div class="input-group">
                                    <label for="lname">Last Name</label>
                                    <input type="text" id="lname" name="lname" class="input"
                                        style="display: inline-block;" value="<?php echo $receptionist->last_Name; ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="dname" name="dname" class="input"
                                    value="<?php echo $receptionist->display_Name; ?>" readonly>
                            </div>

                            <div class="input-group">
                                <label for="address">Home Address</label>
                                <input type="text" id="haddress" name="haddress" class="input2"
                                    value="<?php echo $receptionist->home_Address; ?>" readonly>
                            </div>
                            <div class="parallel">
                                <div class="input-group">
                                    <label for="nic">National Identity Card No.</label>
                                    <input type="number" id="nic" name="nic" class="input"
                                        style="display: inline-block;" value="<?php echo $receptionist->NIC; ?>" readonly>
                                </div>
                                <div class="input-group">
                                    <label for="contactno">Contact Number</label>
                                    <input type="number" id="cno" name="cno" class="input"
                                        style="display: inline-block;" value="<?php echo $receptionist->contact_Number; ?>" readonly>
                                </div>
                            </div>
                            <div class="parallel">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="nic" name="nic" class="input"
                                        style="display: inline-block;" value="<?php echo $receptionist->registration_No; ?>" readonly>
                                </div>
                                <div class="input-group">
                                    <label>Qualifications</label>
                                    <input type="text" id="cno" name="cno" class="input"
                                        style="display: inline-block;" value="<?php echo $receptionist->qualifications; ?>" readonly>
                                </div>
                            </div>
                            <div class="parallel">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="nic" name="nic" class="input"
                                        style="display: inline-block;" value="<?php echo $receptionist->department; ?>" readonly>
                                </div>
                                <!-- <div class="input-group">
                                    <label>Specialization(If any)</label>
                                    <input type="text" id="cno" name="cno" class="input"
                                        style="display: inline-block;" value="<?php echo $receptionist->specialization; ?>" readonly>
                                </div> -->
                            </div>
                        </div>
                </div>
