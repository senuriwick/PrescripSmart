        ...
        <div class="searchDiv">
         ...
         <?php echo"<"; ?>
          <?php if($data['currentPage']>1): ?>
            <a href="<?php echo URLROOT; ?>/admin/searchNurse/<?php echo ($data['currentPage']-1); ?>">Previous</a>
          <?php endif; ?>
          
          <?php for ($i = 1; $i <= $data['totalPages']; $i++): ?>
            <a href="<?php echo URLROOT; ?>/admin/searchNurse/<?php echo $i; ?>"> <?php if($i == $data['currentPage']) ?><?php echo $i; ?></a>
          <?php endfor; ?>

          <?php if($data['currentPage'] < $data['totalPages']): ?>
            <a href="<?php echo URLROOT ?>/admin/searchNurse/<?php echo ($data['currentPage'] + 1) ?>">Next</a>
          <?php  endif; ?>
          <?php echo">"; ?>
       </div>
    </div>
