...
<head>
  ...
  <title>Search a Lab technician</title>
      ...
      <div class="patientInfoContainer">
        ...
        <div class="addapp">
          <div class="newapp">
            ...
            <a href="<?php echo URLROOT ?>/admin/viewReglabtech">NEW LAB TECHNICIAN</a>
          </div>
        </div>
                ...
                <tbody>
                  <?php foreach ($data['allLabtechs'] as $post): ?>
                    <tr class="row">
                      ...
                      <td>
                        <p>Employee ID #<?php echo $post->labtech_ID; ?></p>
                      </td>

                      <td>
                        <a href="<?php echo URLROOT ?>/admin/showProfileLabtech/<?php echo $post->labtech_ID ?>"><button
                            class="profileButton"><b>View Profile</b></button> </a>
                        <form id="deleteForm_<?php echo $post->labtech_ID ?>" method="post"
                          action="<?php echo URLROOT; ?>/admin/deleteProfileLabtech/<?php echo $post->labtech_ID ?>">
                   ...
                   <tbody>
                        ...
                        <p class="name">${patient.gender === 'male' ? 'Mr.' : 'Ms.'} ${patient.first_Name} ${patient.last_Name}</p>
                            ...
                            <form id="deleteForm_${patient.patient_ID}" method="post"
                                action="<?php echo URLROOT; ?>/admin/deleteProfileLabtech/${patient.patient_ID}">
